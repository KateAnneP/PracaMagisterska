...
def main():
    ...
    #f.grupowanie_robocze(features_a, nazwa_tabeli, attributes_info, 1)
    #f.grupowanie_robocze(features_a, nazwa_tabeli, attributes_info, 2)

    reguly_test, reguly_caly = f.grupowanie(features_a, nazwa_tabeli, attributes_info, 1)

...
def main():
    ...
    #f.grupowanie_robocze(all_features, nazwa_tabeli, attributes_info, 1)
    #f.grupowanie_robocze(all_features, nazwa_tabeli, attributes_info, 2)

    reguly_test, reguly_caly = f.grupowanie(all_features, nazwa_tabeli, attributes_info, 1)

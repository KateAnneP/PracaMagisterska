...
def main():
    ...
    cols = [1, 2, 3, 6, 7]
    for col in cols:
        dane.iloc[:, col] = dane.iloc[:, col].map(mapping)
    ...
    # f.grupowanie_robocze(features_d, nazwa_tabeli, attributes_info, 1)
    # f.grupowanie_robocze(features_d, nazwa_tabeli, attributes_info, 2)

    reguly_test, reguly_caly = f.grupowanie(features_d, nazwa_tabeli, attributes_info, 1)
